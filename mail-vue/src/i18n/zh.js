const zh = {
    ...
    recipient: '收件人',
    delivered: '发送成功',
    possiblyOpened: '可能已打开',
    possiblyOpenedCount: '可能已打开 {count} 次，最近：{time}',
    linkClicked: '已点击邮件链接',
    linkClickedCount: '已点击邮件链接 {count} 次，最近：{time}',
    complained: '被标记为垃圾',
    delayed: '发送被延迟',
    bounced: '发送失败',
    attachments: '附件列表',
    ...
    updateIgnored: '当前版本已忽略',
    updateCheckFailed: '检查更新失败，请稍后重试',
    ignoreThisVersion: '忽略本次',
    updateNow: '立即更新',
    updateStarted: '更新任务已提交，系统会在检查通过后部署',
    themeMode: '主题模式',
    themeLight: '白天',
    themeDark: '黑夜',
    themeSystem: '系统',
