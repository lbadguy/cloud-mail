const en = {
    ...
    recipient: 'To',
    delivered: 'Delivered',
    possiblyOpened: 'Possibly opened',
    possiblyOpenedCount: 'Possibly opened {count} times, latest: {time}',
    linkClicked: 'Email link clicked',
    linkClickedCount: 'Email link clicked {count} times, latest: {time}',
    ...
    updateIgnored: 'This version is ignored',
    updateCheckFailed: 'Update check failed. Try again later.',
    ignoreThisVersion: 'Ignore this version',
    updateNow: 'Update now',
    updateStarted: 'Update started. Deployment will continue after validation.',
    community: 'Community',
